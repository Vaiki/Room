...
import com.example.dbroom.databinding.PanelEditProductBinding
...
class PanelEditProduct : BottomSheetDialogFragment(), View.OnKeyListener, View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        idProduct = arguments?.getString("idProduct")?.toInt()
            //заполняем поля редактирования выбранным товаром в TabProduct
    ...
    override fun onClick(view: View) {
        productViewModel?.startUpdateProduct(
